# Operator Quickstart — Hard Coal Mining Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0510** (`cloud-itonami-isic-0510`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0510.git
cd cloud-itonami-isic-0510
```
...
- Blueprint governor key: `coal-mining-governor`
- Likely source path: `coalops.governor.cljc`
